...
public class TokenProcessor {
	...
	public synchronized boolean isTokenValid(HttpServletRequest request) {
		...
		String saved = (String) session.getAttribute("aa");
		if (saved == null) {
			return false;
		}
		...
		String token = request.getParameter("aa");
		if (token == null) {
			return false;
		}
	...
	public synchronized String getToken(HttpServletRequest request) {
		...
		if (null == session)
			return null;
		String token = (String) session.getAttribute("aa");
		if (null == token) {
