...
public class JedisManager {
	private static Log logger = LogFactory.getLog(JedisManager.class);
	...
	// public Collection<Session> AllSession(int dbIndex, String
	// redisShiroSession) throws Exception {
	// Jedis jedis = null;
	// boolean isBroken = false;
	...
	//
	// Set<byte[]> byteKeys =
	// jedis.keys((JedisShiroSessionRepository.REDIS_SHIRO_ALL).getBytes());
