...
//			LogUtils.info(this.getClass(), "删除Session结果：%s" + result);
//		} catch (Exception e) {
//			isBroken = true;
//			throw e;
//		} finally {
...
//	 *            redis数据库下标
//	 * @param bisSessionKey
//	 *            本参数作为逻辑参数区分业务session 如 user:session
//	 *            user的所有session的key都以user:开头 那么bisSessionKey=user
//	 * @return
//	 * @throws Exception
//	 */
//	@SuppressWarnings("unchecked")
//	public Collection<Session> getAllSession(int dbIndex, String bisSessionKey) throws Exception {
//		Jedis jedis = null;
//		boolean isBroken = false;
...
//			jedis.select(dbIndex);
//
//			Set<byte[]> byteKeys = jedis.keys((bisSessionKey + ":*").getBytes());
...
//	 */
//	@SuppressWarnings("unchecked")
//	public Collection<Session> getAllSession(int dbIndex) throws Exception {
//		Jedis jedis = null;
//		boolean isBroken = false;
//		Set<Session> sessions = new HashSet<Session>();
//		try {
