...
(function($) {
	...
	$(document).ready(
			function() {
				...
				$("img[data-type=chooseSex]").on("click", function(){
					if($(this).attr("data-class") == 'active'){
						$(this).removeAttr("data-class");
						$(this).siblings("img").attr("data-class", "active");
						$(this).attr("src", "/images/doc/n_selected_icon .png");
						$(this).siblings("img").attr("src", "/images/doc/selected_icon.png")
					}else{
						$(this).attr("data-class", "active");
						$(this).siblings("img").removeAttr("data-class");
						$(this).attr("src", "/images/doc/selected_icon.png");
						$(this).siblings("img").attr("src", "/images/doc/n_selected_icon .png")
					}
